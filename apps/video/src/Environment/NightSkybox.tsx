...
interface NightSkyboxProps {
  frame: number;
  fps: number;
}

/**
 * Night sky with stars, nebula wisps, and aurora — ported from TowerScene.tsx.
 * Time driven by frame/fps instead of useFrame delta accumulation.
 */
export const NightSkybox: React.FC<NightSkyboxProps> = ({ frame, fps }) => {
    ...
    return new THREE.ShaderMaterial({
      ...
      fragmentShader: /* glsl */ `
        ...
        void main() {
          ...
          vec3 zenithColor   = vec3(0.06, 0.04, 0.18);
          vec3 upperSky      = vec3(0.10, 0.06, 0.22);
          vec3 midSky        = vec3(0.14, 0.08, 0.25);
          vec3 lowerMidSky   = vec3(0.10, 0.12, 0.24);
          vec3 horizonGlow   = vec3(0.06, 0.18, 0.20);
          vec3 belowHorizon  = vec3(0.10, 0.10, 0.14);
          vec3 nadirColor    = vec3(0.07, 0.055, 0.094);
          ...
          if (lat < 0.55) {
            ...
            vec3 wispColor1 = vec3(0.45, 0.18, 0.70);
            ...
            vec3 wispColor2 = vec3(0.12, 0.40, 0.55);
            ...
            vec3 wispColor3 = vec3(0.08, 0.40, 0.30);
            ...
            vec3 wispColor4 = vec3(0.10, 0.50, 0.22);
            ...
            vec3 wispColor5 = vec3(0.06, 0.35, 0.28);
